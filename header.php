...
echo ' <!-- Navbar  -->
    <div class="top">
        <div class="topBar">
            ...
            <a href="index" class="buttons">Home</a>
            <a href="about" class="buttons">What is Eye Travel</a>
    ...
    <!-- eye travel logo-->
        ...
        <div id="smallScreen" class="hide">
            <ul>
                <li><a href="index" class="buttonSmall">Home</a></li>
                <li><a href="about" class="buttonSmall">What is Eye Travel</a></li>
                <li><a href="contact" class="buttonSmall">Contact</a></li>
